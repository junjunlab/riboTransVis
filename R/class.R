globalVariables(c(".", ".I", "enrich", "exonlen", "gene", "gene_name", "idnew","allexp", "ave", "cds", "relexp",
                  ...
                  "sum_1", "sum_2", "total_sum","pause_mean", "pause_sd", "total_counts","lp", "rp",
                  "ribo_count_feature","gstrand", "rstrand", "strand.1"))
...
construct_ribotrans <- function(genome_file = NULL,
  ...
  res <- methods::new("ribotrans",
                      "bam_file" = bam_file,
                      "gtf_data" = gtf,
                      "gtf_path" = ifelse(inherits(gtf_file,"data.frame"),"",gtf_file),
                      "library" = library,
                      "features" = features,
